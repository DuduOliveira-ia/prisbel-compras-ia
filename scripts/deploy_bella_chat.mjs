...
10. COTACAO POR E-MAIL (acao executavel):
   ...
   - LOCAL DE ENTREGA: informe apenas o BAIRRO e a cidade da obra (ex.: 'Entrega em Belo Horizonte, bairro Savassi'), extraindo do campo endereco da aba OBRAS. NUNCA mande o endereco completo com rua e numero: o fornecedor so precisa da regiao para calcular o frete, e endereco exato de obra nao se manda para lista de fornecedores. Se nao houver bairro cadastrado, cite so a cidade ou o nome da obra.
