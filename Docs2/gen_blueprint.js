...
children.push(
  ...
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 120 }, children: [new TextRun({ text: 'Versão 1.1 — 16 de Julho de 2026 (v1.0: 15/07/2026)', size: 22, color: CINZA_ESC })] }),
...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync('Blueprint - Processo de Compras com IA - Prisbel v1.1.docx', buf);
  console.log('OK');
});
